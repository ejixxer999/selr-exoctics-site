  ...
  return (
    <section className="px-6 py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <h1 className="mt-5 text-5xl font-light tracking-wide text-[#f3eadb]">
          Available Motorcars
        </h1>
        <p className="mt-6 max-w-2xl leading-8 text-[#efe3cf]/65">
          Select a vehicle to view specifications, service options, and booking
          availability.
        </p>
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {vehicles?.map((vehicle) => (
            ...
            >
              <div
                className="min-h-80 overflow-hidden bg-cover bg-center transition duration-700 group-hover:scale-105"
                style={{
              ...
              <div className="p-6">
                ...
                <h2 className="mt-3 text-2xl font-light text-[#f3eadb]">
                  {vehicle.name}
                </h2>
                <p className="mt-3 text-sm leading-6 text-[#efe3cf]/60">
                  {vehicle.subtitle}
                </p>
